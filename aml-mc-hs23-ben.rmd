...
### 1.2.4 disp
disp hat disp_id, client_id, welches auf cleitn dataframe verweist und account_id, welches auf account Tabelle verweist sowie den typ, wobei nur OWNER einen Dauerauftrag erstellen koennen und Kredite aufnehmen koennen.
```{r}
...
```{r}
# bei card Dataframe, type junior entfernen, 
# gegbenenfalls auch gold oder umaendern. 
```
