...
## 15.1 Baseline Model - Logistische Regression
...
Random Forest ist ein Ensemble-Lernverfahren, das auf Entscheidungsbäumen basiert.
Es kombiniert mehrere Entscheidungsbäume, um robustere Klassifikationsmodelle zu erstellen.

```{r Andere Algorithmen - Random Forest}
# Create a function to train the Random Forest model and evaluate
train_and_evaluate_rfc <- function(train_index, base_data=FALSE) {
