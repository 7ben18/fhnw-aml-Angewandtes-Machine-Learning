...
data <- left_join(data, non_buyers_fictive_date, by = c("account_id" = "non_buyer_account_id")) %>% mutate(
  issued.card = coalesce(issued.card, fictive_issued.card)) %>% select(-c(fictive_issued.card, jaccard_value, buyer_account_id))
