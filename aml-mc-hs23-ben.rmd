...
### 15.4 Andere Algorithmen - KNN
K-Nearest Neighbors ist ein einfaches, instanzbasiertes Klassifikationsmodell.
Es klassifiziert Beobachtungen, indem es die Klassen der k nächstgelegenen Nachbarn betrachtet.
K-NN eignet sich gut für datengetriebene Aufgaben und erfordert keine Annahmen über die Datenverteilung.
```{r}
