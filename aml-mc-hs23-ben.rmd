...
plot_roc <- function(roc_curves, roc_folds = FALSE, roc_model = FALSE) {
  ...
  aggregated_plot <- aggregated_data %>%
    ...
    labs(title = "ROC Model Performance", x = "False Positive Rate", y = "True Positive Rate", subtitle = "Durchschnittliche Model Performance") + 
    theme_minimal() +
    geom_abline(slope = 1, intercept = 0, linetype = "dashed", color = "gray")
...
result_dtc <- plot_roc(roc_curves_dtc, roc_folds = TRUE, roc_model = TRUE)
...
# View aggregated results
print(xgb_results)
plot_roc(roc_curves = roc_list, roc_folds = TRUE, roc_model = TRUE)
```
