...
full_data <- full_data %>% select(-c("account_id", "date.loan", "type.card", "type.disp"))
...
full_data <- one_hot_encode(full_data, chr_col)
...
full_data <- convert_logical_columns_to_binary(full_data, logical_cols)
full_data
```
